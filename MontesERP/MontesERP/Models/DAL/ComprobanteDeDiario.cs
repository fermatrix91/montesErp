...
namespace MontesERP.Models.DAL
{
    ...
    public partial class ComprobanteDeDiario
    {
        ...
        {
            this.DetalleComprobanteDeDiario = new HashSet<DetalleComprobanteDeDiario>();
        }
        ...
        public virtual ICollection<DetalleComprobanteDeDiario> DetalleComprobanteDeDiario { get; set; }
    }
}
